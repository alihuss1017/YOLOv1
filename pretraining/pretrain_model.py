...
class ClassifierConvNet(nn.Module):

    '''
    20-convolutional layer neural network. 

    Inputs: torch.Tensor of shape (batch_size, C, 224, 224)

    Outputs: torch.Tensor of shape (batch_size, num_classes)
    '''
